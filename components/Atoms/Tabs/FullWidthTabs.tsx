    ...
    <div>
      <div className="sm:hidden">
        ...
        <select
          id="tabs"
          name="tabs"
          className="block w-full rounded-md py-3 px-2 bg-white border-slate-300 focus:border-blue-500 focus:ring-blue-500 uppercase"
        ...
        <nav className="flex divide-x divide-gray-200 rounded-lg shadow">
          {tabs.map((tab) => (
            ...
            >
              ...
              <span
                className={`${
                  tab.id === currentTab ? "bg-blue-600" : "bg-transparent"
