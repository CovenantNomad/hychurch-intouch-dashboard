...
import {useAmazingHoldingList} from "../../../../../../hooks/barnabas/useAmazingHoldingList";
...
import RegisterAmazingButton from "../AmazingWaitingList/_components/RegisterAmazingButton";

type Props = {};

const AmazaingHoldList = ({}: Props) => {
  const {isLoading, data} = useAmazingHoldingList();

  return (
    <div>
      <h4 className="text-lg font-semibold mb-4">어메이징 과정 보류자</h4>
...
export default AmazaingHoldList;
