...
import {insertYearCellMeetingValue} from "../../../../../../firebase/CMS/CMS";
...
const YearCMS = ({}: Props) => {
  ...
  const mutation = useMutation(insertYearCellMeetingValue, {
    onSuccess: () => {
  ...
  return (
    <div>
      <h1 className="mb-5 text-lg font-semibold">연간데이터 입력 사항</h1>
