            ...
            <div className="min-w-full py-2 align-middle sm:px-6 lg:px-8">
              <table className="min-w-full divide-y divide-gray-300 border border-gray-300">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {report.memberReports.slice(0, 10).map((member) => (
                    <tr
                      key={member.id}
                      className="inline-flex divide-x divide-gray-200"
                    >
                      <td className="flex w-[36px] p-2 whitespace-nowrap items-center justify-center text-sm font-medium text-black print:text-[13px]">
                        {member.order}
                      </td>
                      <td className="flex w-[64px] p-2 whitespace-pre-wrap items-center justify-center text-sm text-black print:text-[13px]">
                        {member.name}
                      </td>
                      <td className="flex w-[44px] p-2 whitespace-pre-wrap items-center justify-center text-sm text-black print:text-[13px]">
                        {member.meeting}
                      </td>
                      <td className="flex w-[76px] p-2 whitespace-pre-wrap items-center justify-center text-center text-sm text-black print:text-[13px]">
                        {`젊은이예배\n(성전)`}
                      </td>
                      <td className="flex w-[52px] p-2 whitespace-pre-wrap items-center justify-center text-sm text-black print:text-[13px]">
                        {member.cellMeeting ? "참석" : "불참"}
                      </td>
                      <td className="flex-1 p-2 whitespace-pre-wrap text-sm text-black print:text-[13px]">
                        {member.story}
                      </td>
                      <td className="flex-1 p-2 whitespace-pre-wrap text-sm text-black">
                        <ul className="list-outside pl-4">
                          {member.praylist.map((pray) => (
                            <li key={pray.id} className="list-decimal print:text-[13px]">
                              {pray.content}
                            </li>
                          ))}
                        </ul>
              ...
              <table className="min-w-full divide-y divide-gray-300 border border-gray-300">
                <thead>
                  <tr className="grid grid-cols-8 divide-x divide-gray-200">
                    <th
                      scope="col"
                      className="col-span-1 py-1 justify-center items-center text-center text-sm font-semibold text-gray-900 print:text-[13px]"
                    >
                      개인기도
                    </th>
                    <th
                    ...
                    <th
                      scope="col"
                      className="col-span-1 py-1 justify-center items-center text-center text-sm font-semibold text-gray-900 sm:pr-0 print:text-[13px]"
                    >
                      금요성령집회
                    </th>
                  </tr>
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  <tr className="grid grid-cols-8 divide-x divide-gray-200">
                    <td className="col-span-1 py-2 justify-center items-center whitespace-nowrap text-center text-base text-black print:text-[13px]">
                      {report.leaderReport.individualPray}
                    </td>
                    <td className="col-span-1 py-2 justify-center items-center whitespace-pre-wrap text-center text-base text-black print:text-[13px]">
              ...
              <div className="min-h-[48px] border border-gray-300 px-4 py-2">
                <p className="text-base text-black whitespace-pre-line print:text-[13px]">{report.toPastor}</p>
              </div>
            </div>
          </div>
        </div>
