...
import {
  ...
  useCompleteAttendanceCheckMutation,
...
const AttendanceHeader = ({
  ...
  const {isLoading: isAttendanceLoading, data: attendanceChekcStatus} =
    useFindAttendanceCheckQuery<
      FindAttendanceCheckQuery,
      FindAttendanceCheckQueryVariables
    >(
      ...
      <div className="flex justify-end items-center mt-8 lg:my-auto lg:ml-auto lg:mt-0">
        ...
        <div>
          {isAttendanceLoading ? (
            ...
            <>
              {attendanceChekcStatus &&
              attendanceChekcStatus.attendanceCheck ===
                ...
                <button
                  ...
                  disabled={
                    isLoading ||
                    !attendanceStatus ||
                    data?.completeAttendanceCheck.attendanceCheck.status ===
                      AttendanceCheckStatus.Completed
                  }
