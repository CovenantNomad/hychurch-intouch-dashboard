...
const SpecialCellAttendanceUserList = ({ cellName, memberList, attendanceList, searchedMember, setSearchedMember, onSaveAttendanceList }: SpecialCellAttendanceUserListProps) => {
...
export default SpecialCellAttendanceUserList;
