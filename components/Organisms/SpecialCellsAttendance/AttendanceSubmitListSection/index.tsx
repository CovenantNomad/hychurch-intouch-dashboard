...
const AttendanceSubmitListSection = ({
  attendanceSubmitList,
}: AttendanceSubmitListSectionProps) => {
  const groupedByService = useMemo(() => {
    if (!attendanceSubmitList || attendanceSubmitList.length === 0) return {};
    return groupBySubmitListByChurchServiceId(attendanceSubmitList);
  }, [attendanceSubmitList]);
