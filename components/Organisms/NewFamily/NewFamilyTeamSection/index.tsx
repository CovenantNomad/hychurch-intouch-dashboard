...
const NewFamilyTeamSection = ({ teamList }: NewFamilyTeamSectionProps) => {
  return (
    <div>
      ...
      <div className="w-full mx-auto grid grid-cols-2 gap-y-12 gap-x-6 py-4 lg:py-6 text-center sm:grid-cols-3 md:grid-cols-4 lg:mx-0 lg:max-w-none lg:grid-cols-5 xl:grid-cols-6">
        {teamList.map(member => (
