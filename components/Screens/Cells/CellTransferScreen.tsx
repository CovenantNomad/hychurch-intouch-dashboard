...
import { FindCellWithTranferDataQuery, FindCellWithTranferDataQueryVariables, useFindCellWithTranferDataQuery, UserCellTransferStatus } from '../../../graphql/generated';
...
const CellTransferScreen = ({}: CellTransferProps) => {
  ...
  const tabs = [
    ...
    { id: 1, name: "셀원이동 승인처리", component: <TransferConfirm data={data} isLoading={isLoading} />},
    { id: 2, name: "셀원이동 결과확인", component: <TransferHistory data={data} isLoading={isLoading} />},
  ]
  ...
  return (
    <div className='grid grid-cols-1 xl:grid-cols-12'>
      ...
      <div className='mt-6 border border-[#e5e5e5] xl:col-span-9 '>
